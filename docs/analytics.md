...
A workflow starts with a data block and is usually followed by one or more processing blocks. You can add one data block and up to five processing blocks to a workflow.
