...
| `sources`          | **list[str]**<br/>Asset sources. Use to search for assets from any of the provided sources. The allowed values are as follows:<br/><ul><li>`ARCHIVE`: assets from catalog orders</li><li>`TASKING`: assets from tasking orders</li><li>`PROCESSING`: assets resulting from processing</li><li>`USER`: assets uploaded by users</li></ul>                                                                                                                                               |
