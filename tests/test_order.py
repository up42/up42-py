...
class TestOrderAllWorkspaceIdDeprecation:
    ...
    def test_should_warn_on_workspace_id_parameter(
        ...
        requests_mock.get(
            f"{constants.API_HOST}/v2/orders?workspaceId=test-workspace-id&page=0",
    ...
    def test_should_use_workspace_id_in_api_call(
        self, requests_mock: req_mock.Mocker
    ):
        ...
        assert "workspaceId=test-workspace-id" in mock.last_request.url
