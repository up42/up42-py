...
def collect_credentials(
        cfg_file: Union[str, pathlib.Path, None], project_id: Optional[str],
...
class Auth:
    def __init__(
            ...
            create_client=up42.http.client.create,
            **kwargs,
    ):
        """
    ...
    def token(self) -> Optional[str]:
        return self._client and self._client.token
