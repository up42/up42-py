...
from up42.main import _check_auth, _get_auth_safely
...
def _get_project_id(project_id: Optional[str]) -> str:
    ...
    result = project_id or str(_get_auth_safely().project_id)
    if not result:
...
def initialize_project(project_id: Optional[str] = None) -> "Project":
    ...
    project = Project(auth=_get_auth_safely(), project_id=_get_project_id(project_id=project_id))
...
def initialize_catalog() -> "Catalog":
    ...
    """
    return Catalog(auth=_get_auth_safely())
...
def initialize_tasking() -> "Tasking":
    ...
    """
    return Tasking(auth=_get_auth_safely())
...
def initialize_storage() -> "Storage":
    ...
    """
    return Storage(auth=_get_auth_safely())
...
def initialize_order(order_id: str) -> "Order":
    ...
    """
    order = Order(auth=_get_auth_safely(), order_id=order_id)
...
def initialize_asset(asset_id: str) -> "Asset":
    ...
    """
    asset = Asset(auth=_get_auth_safely(), asset_id=asset_id)
...
def initialize_webhook(webhook_id: str) -> Webhook:
    ...
    """
    webhook = Webhook(auth=_get_auth_safely(), webhook_id=webhook_id)
